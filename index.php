...
<title>Multiusuarios : Niveles de Usuarios</title>
...
//CONDICIONAL PARA SI INICIA EL ABMINISTRADOR
...
//CONDICIONAL PARA SI INICIA UNA CUENTA PERSONAL
...
if(isset($_REQUEST['btn_login']))	
{
	...
	else if($email AND $password AND $role)
	{
		try
		{
			$select_stmt=$db->prepare("SELECT email,password,role FROM logi
										WHERE
