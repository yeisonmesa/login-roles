...
<a href="index.html">paginas</a>
 <a href="../registro.php"><p class="text-info">CREAR NUEVO USUARIO</p></a>
	...
	<div class="container">
		...
		<div class="col-lg-12">
			...
			<center>
				...
				<!-- ¿QUIERES CREAR UNA CUENTA? <a href="../registro.php"><p class="text-info">CREAR CUENTA</p></a>	 -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									$select_stmt=$db->prepare("SELECT id,username,email,role FROM logi");
									$select_stmt->execute();
